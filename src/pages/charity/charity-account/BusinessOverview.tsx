...
const BusinessOverview: React.FC<BusinessOverviewProps> = ({ data }) => {
  ...
  const weeklyRevenueIncrease = (
    data.revenue *
    (data.revenueChange / 100)
  ).toFixed(2);
  const weeklyItemsSoldIncrease = Math.round(
    data.itemsSold * (data.itemsSoldChange / 100)
  );
  const weeklyMoneySpentIncrease = (
    data.moneySpent *
    ...
    <div className="grid grid-cols-12 sm:grid-cols-6 gap-6 business-overview-area pb-[45px]">
      ...
      <div className="col-span-3 sm:col-span-full md:col-span-6">
        ...
        <p className="body-bold-large sm:body-bold-medium flex items-center gap-2 ">
          ...
          <span
            className={`px-2 py-[2px] forms-bold ${data.revenueChange >= 0 ? 'text-[#00C700] bg-[rgba(165,255,187,.60)]' : 'text-[#FF0000] bg-[rgba(255,187,187,.60)]'} rounded-full`}
          >
      ...
      <div className="col-span-3 sm:col-span-full md:col-span-6">
        ...
        <p className="body-bold-large sm:body-bold-medium flex items-center gap-2 ">
          {data.itemsSold}
          <span
            className={`px-2 py-[2px] forms-bold ${data.itemsSoldChange >= 0 ? 'text-[#00C700] bg-[rgba(165,255,187,.60)]' : 'text-[#FF0000] bg-[rgba(255,187,187,.60)]'} rounded-full`}
          >
      ...
      <div className="col-span-3 sm:col-span-full md:col-span-6">
        ...
        <p className="body-bold-large sm:body-bold-medium flex items-center gap-2 ">
          {data.itemsBought}
          <span
            className={`px-2 py-[2px] forms-bold ${data.itemsBoughtChange >= 0 ? 'text-[#00C700] bg-[rgba(165,255,187,.60)]' : 'text-[#FF0000] bg-[#FFCECD]'} rounded-full`}
          >
        ...
        <p className="body-bold-small mt-2">
          -4 <span className="text-[#C9C8CA]">in the past week</span>
        </p>
      </div>
      ...
      <div className="col-span-3 sm:col-span-full md:col-span-6">
        ...
        <p className="body-bold-large sm:body-bold-medium flex items-center gap-2 ">
          ...
          <span
            className={`px-2 py-[2px] forms-bold ${data.moneySpentChange >= 0 ? 'text-[#00C700] bg-[rgba(165,255,187,.60)]' : 'text-[#FF0000] bg-[rgba(255,187,187,.60)]'} rounded-full`}
          >
        ...
        <p className="body-bold-small mt-2">
          + £{weeklyMoneySpentIncrease} in the past week
        </p>
      </div>
    </div>
  );
