...
const UsersProductListingArea: React.FC<UsersProductListingAreaProps> = ({
  products = [],
}) => {
  ...
  const filterByDeliveryTime = (products: Product[]) => {
    ...
    const [minTime, maxTime] = selectedDeliveryTime
      .split('-')
  ...
  const draftProducts = filterByDeliveryTime(
    ...
    <div className="product-handle-listing-area sm:bg-[#F1F1F7]">
      <div className="delivery-time-filter ml-auto flex mb-6 items-center justify-end sm:justify-start sm:items-start sm:flex-col sm:mb-0 sm:ml-0 sm:max-w-[250px] pt-6 sm:px-[5px]">
        <label
          ...
          className="mr-2 sm:mb-3 body-bold-small whitespace-nowrap"
        >
        ...
        >
          <option className="body-small" value="">
            All
          </option>
          <option className="body-small" value="2-5">
            2-5 business days
          </option>
          <option className="body-small" value="5-7">
            5-7 business days
          </option>
          <option className="body-small" value="7-12">
            7-12 business days
          </option>
        </select>
      </div>
              ...
              draftProducts.map(product => (
                <ProductCard
                 ...
                 charityImageSrc={product.charityImageSrc ?? '/path/to/default-image.png'} 
                  ...
                  onDeleteConfirm={id => handleDeleteConfirm(parseInt(id))}
                  isLoggedIn={true}
                />
              ))
            ) : (
