        ...
        <section className="basket-page-main-content-grid grid grid-cols-12 gap-5">
          <div className="basket-page-left-cont col-span-7 md:col-span-6 sm:col-span-full">
            ...
            <div className="">
              ...
              <div>
                <h3 className="h5 font-primary text-mono-100">
                  Payment Method
                </h3>
                <div className="border p-4 mb-4">
                  <div className="flex justify-between">
              ...
              <div className="bg-white rounded-lg w-full max-w-md p-6 relative">
                ...
                <div className="flex items-start mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      The charity that hosts the item will receive 90% of the
                ...
                <div className="flex items-start mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Angelpage retains the remaining 10% of each item cost.
                      This helps Angelpage support users of the platform.
                    </p>
                  </div>
                </div>
                <div className="flex justify-end">
