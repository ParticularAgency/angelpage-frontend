              ...
              <div className="relative mt-[15px]">
                <div className="flex flex-col space-y-6 sm:space-y-3 pl-7 relative sold-product-items-main-item-content">
                  ...
                  {selectedItem.stages.saleProceeding && (
                    <div className="flex p-4 bg-mono-0 relative flex-col gap-1 items-start">
                      <div
                        className={`w-6 h-6 flex justify-center items-center rounded-full absolute dots-item-indicator left-[-38px] bottom-0 ${selectedItem.stages.saleProceeding ? 'bg-[#6A0398]' : 'states-not-complete !left-[-36px]'}`}
                      >
                        {selectedItem.stages.saleProceeding && (
                          <Image
                      ...
                      <div>
                        <p className="body-bold-small">
                          Sale proceeds sent to{' '}
                          {selectedItem.saleDetails.sentTo}
                        </p>
                        <p className="forms text-mono-70 mt-1">
                          {selectedItem.saleDetails.date}
                        </p>

                        {/* Display dynamic charity and admin fee calculation */}
                        <div>
                          {(() => {
                            const { charityProceeds } = calculateFees(
