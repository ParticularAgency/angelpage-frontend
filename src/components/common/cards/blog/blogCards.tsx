      ...
      {blogData.map((blog: any) => (
        ...
        >
          <div className="relative w-full h-48">
            <span className="absolute top-2 left-2 z-10 uppercase text-[#fff] bg-[#611192] p-2 text-center text-[10px] font-bold">
              {blog.tag}
            </span>
          ...
          <div>
            <Link href={`blog/${blog.id}`}>
              <p className="font-bold text-[12px] uppercase text-[#611192] mt-4 mb-3">
                {blog.title}
              </p>
            </Link>
