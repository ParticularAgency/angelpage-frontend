            ...
            <div className="header-top-cont">
              <div className="custom-container">
                <div className="header-top-wrapper py-4 grid grid-cols-12 sm:grid-cols-6 gap-6">
                  ...
                  <div
                    className={`header-right-cont sm:col-span-2 flex items-center gap-4 justify-end col-span-5 ${isLoggedIn ? 'md:col-span-10' : ''}`}
                  >
                    {isTempLogin && (
                      <>
                        <GlobalSearch />
                        ...
                        <div className="user-account flex items-center sm:hidden">
                          <Link
                            href={`${shouldHideBottomNav && isLoggedIn ? '/user/account/1' : '/auth/login'}`}
                          >
                            <UserIcon />
                          </Link>
                        </div>
