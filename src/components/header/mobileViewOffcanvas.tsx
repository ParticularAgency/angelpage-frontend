              ...
              <div className="menu-canvas-area min-h-full">
                <div className="megamenu-navigation-box">
                  <ul className="menu bg-transparent p-0 rounded-none">
                    <li>
                      <details>
                        <summary className="!bg-transparent p-0  px-4  py-5 rounded-0 !!text-mono-100 !opacity-100 !text-body-regular !font-normal leading-[150%] font-secondary">
                          Women
                        </summary>
                        <ul className="!p-0 !m-0">
                          <li>
                            <details>
                              <summary className="!bg-transparent p-0 pl-8  pr-4 rounded-0 !text-mono-70 py-4 !text-body-eyebrow-small !opacity-100 !font-bold leading-[150%] font-secondary uppercase tracking-[.5px]">
                                Clothing
                              </summary>
                              <ul className="!p-0 !m-0 !pt-3 !pb-6 link-lists-item-menu !pl-8  flex flex-col gap-3">
                                <li>
                                  <Link
                                    className="!p-0 px-4 font-secondary font-light !text-mono-100 text-left text-body-small leading-[150%] tracking-[.7px]"
                                    href="/"
                                  >
                                    Skirts
                                  </Link>
