      ...
      <div className="mini-cart-offcanvas">
        <div className="drawer drawer-end">
          ...
          <div className="drawer-content">
            <label htmlFor="my-drawer-4" className="drawer-button btn !bg-transparent !p-0 !border-none">
              <CartIcon />
            </label>
          </div>
              ...
              <div className="offcanvas-head mini-cart-header-and-main-wrea min-h-full">
                <div className="minicart-header px-6">
                  <div className="cart-head-top border-b pt-8 pb-5 flex justify-between items-center border-b-mono-60">
                    ...
                    <label htmlFor="my-drawer-4" aria-label="close sidebar" className="close-btn w-8 h-8 flex items-center justify-center cursor-pointer">
                      <CloseIcon />
                    </label>
                  </div>
                </div>
                  ...
                  <div className="cart-add-product-item-wrapper">
                    <div className="cart-add-product-item flex items-center gap-5 py-5">
                      <div className="minicart-product-img">
                        <Image src="/images/products/product1.png" width={116} height={110} alt="product small image" />
                      </div>
                      <div className="minicart-product-info">
                        <h5 className="body-medium">Hollister</h5>
                        <p className="body-small">Crew Neck Jumper</p>
                        <p className="body-small flex items-center gap-1">Charity: <span>The Salvation Army</span></p>
                ...
                <div className="cart-canvas-area min-h-full">
                  <div className="cart-footer-area px-6 pt-[46px] pb-12">
                    <div className="totat-price flex items-center justify-between">
                      ...
                      <p className="body-small">£{(24.99 * productQuantity).toFixed(2)}</p>
                    </div>
                    <p className="info-text forms-bold mt-[9px]">Tax and shipping are calculated at checkout</p>
                    <Button variant="primary" className="max-w-full w-full rounded-[50px] mt-4" onClick={() => console.log('Should not click')}>Checkout</Button>
                  </div>
                </div>
              </div>
