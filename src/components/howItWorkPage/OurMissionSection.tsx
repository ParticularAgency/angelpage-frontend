        ...
        <div className="flex md:flex-col"> 
          ...
          <div className="bg-[#F1F1F7] md:w-full pt-20 pl-[69px] pr-[80px] sm:px-5 md:py-10 w-2/5">
            ...
            <div className="mt-[70px] flex">
              <Button variant='primary' className='inline-block' onClick={() => console.log('Should not click')}> Start Selling for Free</Button>
              <Button variant='accend-link' className='flex items-center' onClick={() => console.log('Should not click')}>Browse Items  <Image
                  width={24}
                  height={24}
