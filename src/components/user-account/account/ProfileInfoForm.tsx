        ...
        {!isEditing ? (
          <>
            <p className="personal-info-item body-small">
              ...
              <span className="inline-block">{charityInfo.firstName}</span>
            </p>
            <p className="personal-info-item body-small">
              <span className="inline-block whitespace-nowrap text-right">
                Last name
              </span>{' '}
              <span className="inline-block">{charityInfo.lastName}</span>
            </p>
            <p className="personal-info-item body-small">
              <span className="inline-block whitespace-nowrap text-right">
                Date of birth
              </span>{' '}
              <span className="inline-block">{charityInfo.dateBirth}</span>
            </p>
          </>
        ) : (
          <>
