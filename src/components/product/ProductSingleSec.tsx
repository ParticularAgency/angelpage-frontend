        ...
        <div className="product-singlepage-cont-wrapper w-full max-w-[895px] flex items-start justify-between gap-[92px] lg:gap-14 md:gap-10 sm:gap-12 pb-[83px] sm:pb-12 sm:flex-col">
            ...
            <div className="swiper-product-slider-area flex sm:flex-col-reverse items-start gap-2">
              <div className="swiper-product-slide-tab-item flex flex-col sm:flex-row gap-3">
                <div className="slide-tab-item">
                  <Image
                    src="/images/products/product-view-img1.jpeg"
                ...
                <div className="slide-tab-item">
                  <Image
                    src="/images/products/product-view-img2.jpeg"
                    className="w-12 h-12 object-cover cursor-pointer"
                    alt="product list image"
                    width={48}
                    height={48}
                ...
                <div className="slide-tab-item">
                  <Image
                    src="/images/products/product-view-img3.jpeg"
                    className="w-12 h-12 object-cover cursor-pointer"
                    alt="product list image"
                    width={48}
                    height={48}
                ...
                <div className="slide-tab-item">
                  <Image
                    src="/images/products/product-view-img4.jpeg"
                    className="w-12 h-12 object-cover cursor-pointer"
                    alt="product list image"
                    width={48}
                    height={48}
                ...
                <div className="slide-tab-item">
                  <Image
                    src="/images/products/product-view-img5.jpeg"
                    className="w-12 h-12 object-cover cursor-pointer"
                    alt="product list image"
                    width={48}
                    height={48}
              ...
              <div className="swiper-slider-view w-full relative">
                <Image
                  ...
                  className="w-12 h-12 object-cover absolute p-1 top-2 left-2"
                  alt="product list image"
                  width={64}
                  height={64}
                />
                <Image
                  src="/images/products/product-view-img3.jpeg"
                  className="w-full max-w-[359px] sm:h-[340px] h-[452px] object-cover"
                  alt="product list image"
                  width={359}
                  height={452}
                />
          ...
          <div className="product-singlepage-right-cont max-w-[388px] w-full">
            ...
            <ul className="product-highlight-info mb-4 flex items-center sm:flex-wrap gap-2">
              <li
                key="condition"
                className="product-highlight-info-item product-condition caption py-[4px] px-2 rounded-[16px] bg-primary-color-70 text-primary-color-100"
              >
                Used
              </li>
              <li
                key="shipping"
                className="product-highlight-info-item product-shipping-from caption py-[4px] px-2 rounded-[16px] bg-primary-color-70 text-primary-color-100"
              >
                Shipping from London, UK
              </li>
              <li
                key="delivery"
                className="product-highlight-info-item product-delivery-type caption py-[4px] px-2 rounded-[16px] bg-primary-color-70 text-primary-color-100"
              >
                5-7 business days
              </li>
            </ul>
            ...
            <div className="product-price-group flex items-end gap-2 mb-6 max-w-[306px] sm:max-w-[375px] w-full">
              ...
              <div className="product-price-item charity-profit-received  max-w-full w-full">
                ...
                <p className="input-type-text body-bold-small flex items-center py-[9.5px] px-2 w-full h-10 bg-[#f1f1f1]">
            ...
            <div className="product-cta-box flex flex-col gap-4 mb-6 max-w-[306px] sm:max-w-[375px] w-full">
              ...
              <Button
                className="link-to-charity-storefront-btn !text-primary-color-100 !border-primary-color-100"
                variant="secondary"
                onClick={() => console.log('View charity storefront')}
              >
            ...
            <div className="product-specification-box">
              ...
              <ul className="product-specification-lists flex flex-col gap-3">
                ...
                >
                  <span className="specification-title body-bold-small">
                    Condition:
                  </span>
                ...
                <li
                  key="spec-condition"
                  className="specification-items flex flex-col items-center gap-2"
                >
                  <span className="specification-title body-bold-small w-full">
                    Additional info
                  </span>
                  <span className="specification-info body-small">
