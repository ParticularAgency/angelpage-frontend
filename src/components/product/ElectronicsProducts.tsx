...
const electronicsCategories = [
  { id: '1', imageSrc: '/images/products/electronics-cat-img1.png', imageAlt: 'Phone', categoryTitle: 'Phone' },
  { id: '2', imageSrc: '/images/products/electronics-cat-img2.png', imageAlt: 'Laptop', categoryTitle: 'Laptop' },
  { id: '3', imageSrc: '/images/products/electronics-cat-img3.png', imageAlt: 'Headphone', categoryTitle: 'Headphone' },
  { id: '4', imageSrc: '/images/products/electronics-cat-img4.png', imageAlt: 'Light', categoryTitle: 'Light' },
  { id: '5', imageSrc: '/images/products/electronics-cat-img5.png', imageAlt: 'Monitor', categoryTitle: 'Monitor' },
];
