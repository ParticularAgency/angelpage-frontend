...
const Sorting: React.FC<SortingProps> = ({ onSortChange }) => {
  return (
    <div className="sorting flex items-center gap-[14px] sm:gap-[4px] bg-transparent border-0">
      ...
      >
        <option value="price-asc" className="py-[11px] px-2 bg-[#FCF2FF] caption">Price: low - high</option>
        <option value="price-desc" className="py-[11px] px-2 bg-[#FCF2FF] caption">Price: high - low</option>
        ...
        <option value="date-desc" className="py-[11px] px-2 bg-[#FCF2FF] caption">Most recent</option> {/* Optional */}
      </select>
    </div>
  );
};
