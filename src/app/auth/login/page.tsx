                    ...
                    {activeTab === 'individual' && (
                        <form >
                            ...
                            <div className="text-right">
                                <a href="#" className="text-sm text-primary-color-100">Forgot password</a>
                            </div>
                            <Button type='submit' variant='tertiary' className='w-full my-6'>Login</Button>
                            <p className="text-body-small">
                                New here? <a href="/auth/register" className="text-primary-color-100 underline">Create an account</a>
                            </p>
                        </form>
                    )}
