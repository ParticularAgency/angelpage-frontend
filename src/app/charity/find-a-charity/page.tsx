    ...
    return (
        <div>
            <div className="custom-container">
                <div className="grid grid-cols-6 md:grid-cols-3 sm:grid-cols-2 gap-4">
                    {charityImages.map((image, index) => (
                        <div key={index} className="overflow-hidden shadow-lg max-w-[237px] w-full h-[299px]">
            ...
            <div className="pt-[79px] pb-[59px]">
                ...
                <div className="px-4">
                    <CharitySearch onSearch={handleSearch} onClear={handleClear} /> {/* Added onClear prop */}
                </div>
            </div>
            <div className="bg-[#F9F9F9] pt-[95px] pb-[173px] mb-[23px]">
                <div className="custom-container">
                    {searchMessage && <p className="text-red-600 text-center">{searchMessage}</p>}
