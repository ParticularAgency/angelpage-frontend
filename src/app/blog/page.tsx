    ...
    <div>
      <div className="container py-[74px]">
        ...
        <p className=" text-[#0B0112] text-[14px]">
          Stay updated with the latest news, tips, and stories from Angelpage. Learn more about sustainable living, charitable giving, <br className="sm:hidden" /> and the impact of your contributions.
        </p>
      </div>
